        ...
        <Grid columns="equal" stackable>
          <Grid.Column style={{ paddingBottom: "2rem", paddingTop: "2rem" }}>
            <Image
              size="medium"
              centered
              src="https://d3nn82uaxijpm6.cloudfront.net/assets/website/experiments/akita/variant_c/devices-header-3349320fa849e6a297a3b0d64a6dfdef7307b0fe50f6329a459a0105b76ffff8.jpg"
            />
            ...
            <List ordered>
              ...
              <List.Item>
                If you don't already have the Fitbit or Strava app on your
                phone, please download and install this on your{" "}
                <a
              ...
              <List.Item>
                Follow the prompts in the chosen app to create your personal
                account
              </List.Item>
              <List.Item>
              ...
              <List.Item>
                Click 'Register with Fitbit/Strava' and you'll be taken to a
                page which will ask you to give permission for Capco to access
                your activity and location data. Please click 'allow'
              </List.Item>
              <List.Item>
                Either wear and sync your device or enter data manually through
                the Strava/Fitbit application. You can also setup your iPhone to
                track your activity – <a href="/faq"> see our FAQ</a>
              </List.Item>
            </List>
          </Grid.Column>
          <Grid.Column
