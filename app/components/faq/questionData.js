  ...
  "general": [
    {
      ...
      answerText: "Please get in touch with <a href='mailto:3cd19d49.capco.com@apac.teams.ms'>Challenge Team Support</a> and request to de-register, or ask for help with re-registering."
    },
    {
    ...
    },
    {
      ...
      answerText: "If you do not have a smart device but do have smart phone (not <i>all</i> phones are supported) and wish to use this to track activity you can do so using the fitbit app – setup instructions here; <a href='https://help.fitbit.com/articles/en_US/Help_article/1875.htm#:~:text=MobileTrack%20lets%20you%20use%20the,%2C%20sleep%2C%20or%20active%20minutes'> Mobile Track Guide</a>."
    },
    {
  ...
  "team": [
    {
      ...
      answerText: "Please follow the steps to either join or setup a team through the <a href='/register'> Registration page</a>."
    },
    {
  ...
  "data": [
    {
      ...
      answerText: "Please view the daily report for users and data sync success. Available in Teams channel."
    },
    {
    ...
    },
    {
      ...
      answerText: "No, Capco does not retrieve, store or process your GPS data if available from Strava / Fitbit. Capco cannot see your location."
    },
    {
