export const questionData = {
  ...
  trackingActivity: [
    ...
    },
    {
      ...
      answerText:
        'Cycling distances will be converted using a ratio of 3:1 throughout the Challenge to allow comparable participation across walkers, runners and cyclists. This is one of the broadly accepted conversion ratios. Do not amend distances in the Strava/Fitbit app completed by bike – the Global Challenge platform will do this for you.',
    },
  ],
  team: [
    {
