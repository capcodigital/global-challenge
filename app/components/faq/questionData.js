  ...
  "general": [
    {
      ...
      questionText: "How do I un-register or re-register for the challenge?",
      answerText: "Please get in touch with <a href='mailto:3cd19d49.capco.com@apac.teams.ms'>Challenge Team Support</a> and request to de-register."
    },
    {
      questionId: "how-do-I-see who-else-is-registered",
      questionText: "How do I see who else is registered?",
      answerText: "A daily update on registered teams / participants will be provided."
    },
    {
      questionId: "how-do-I-update-my-data",
      questionText: "How do I update my data?",
    ...
    },
    {
      ...
      answerText: "If you do not have a smart device but do have smart phone (not ALL phones are supported)  and wish to use this to track activity you can do so using the fitbit app – setup instructions here; <a href='https://help.fitbit.com/articles/en_US/Help_article/1875.htm#:~:text=MobileTrack%20lets%20you%20use%20the,%2C%20sleep%2C%20or%20active%20minutes'> Mobile Track Guide</a>."
    },
    {
      questionId: "how-to-setup-apple-watch",
      questionText: "How do I setup My Apple Watch to sync with the application?",
      answerText: "Please ensure that you have setup Strava on your Apple watch and then link your Strava account to sync with the Challenge. It is possible to link your Apple Watch to Fitbit, via Strava and then link your FitBit account to Challenge application. Detailed instructions <a href='https://www.theverge.com/2019/8/27/20830247/fitbit-app-apple-watch-strava-connect-how-to'> Link Apple Watch to Fitbit (Via Strava)</a>."
    }
  ],
  "team": [
    {
      ...
      answerText: "Please follow the steps to either join or setup a team through the <a href='/register'> Registraion page</a>."
    },
    {
      questionId: "how-to-leave-a-team",
      questionText: "How do I leave a team?",
      answerText: "You should receive an email from <a href='mailto:3cd19d49.capco.com@apac.teams.ms'>Challenge Team Support</a> with a unique link to leave a team. Please use the link and then join the team you want to join."
    },
    {
      questionId: "how-do-I-rename-a-team",
      questionText: "How do I rename my team?",
      answerText: "Please contact <a href='mailto:3cd19d49.capco.com@apac.teams.ms'>Challenge Team Support</a> and request to change the team name – this may not be possible."
    },
    {
      questionId: "how-do-i-see-which-teams-have-spaces",
      questionText: "How do I see which teams have spaces?",
      answerText: "Please see the daily report containing Registered Teams / individual participants."
    },
    {
      questionId: "how-do-i-remove-someone-from-my-team",
      questionText: "How do I remove someone from my Team?",
      answerText: "Please contact the individual directly and request that they leave the team using the unique link they will have received in an email from the Capco.Challenge.com team when they registered. If unsuccessful contact <a href='mailto:3cd19d49.capco.com@apac.teams.ms'>Challenge Team Support</a> and request assistance."
    },
  ],
  "data": [
    {
      ...
      answerText: "Please view the daily report for users and data sync success. [Link to Office 365.xls?]"
    },
    {
      questionId: "why-is-my-data-not-syncing",
      questionText: "Why is my data not syncing with the Challenge application?",
      answerText: "<ul><li>Please confirm you have registered correctly by trying to register again.</li><li> If this does not work then, please open and refresh your selected fitness app (Fitbit / Strava) and allow <b>1 hour</b> for data to sync.</li><li> If the previous two steps do not work, please contact <a href='mailto:3cd19d49.capco.com@apac.teams.ms'>Challenge Team Support</a> for further assistance.</li></ul>"
    },
    {
      questionId: "will-you-see-my-location",
      questionText: "Will you see my location",
      answerText: "No, Capco does not retrieve, store or process your GPS data if available from Strava / Fitbit. Capco can not see your location."
    },
    {
    ...
    },
    {
      ...
      answerText: "Your data will be stored for the duration of the challenge, plus a further 30 days. Following this date all personally identifying data will be deleted."
    },
    {
      questionId: "how-is-cycling-distance-converted",
      questionText: "How is cycling distance converted?",
      answerText: "Cycling distance is converted by a Ratio or 3:1 throughout the challenge (less for the individual cycling “actual distance” detail)."
    }
  ],
}