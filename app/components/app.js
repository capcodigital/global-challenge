...
import DashboardGlobal, {
  TeamsDashboardGlobal,
} from "./global/dashboard/dashboard.container";
import DashboardUK, {
  TeamsDashboardUK,
} from "./uk/dashboard/dashboard.container";
...
function App() {
  ...
  return (
    <div className="app-wrapper">
      {process.env.CHALLENGE_NAME === "global" || process.env.CHALLENGE_NAME === undefined && (
        <>
          <Helmet
      ...
      {process.env.CHALLENGE_NAME === "uk" && (
        <>
          <Helmet
            titleTemplate="%s - UK ESTR Challenge"
            defaultTitle="Capco UK ESTR Challenge"
          >
            <meta name="description" content="Capco UK ESTR Challenge" />
          </Helmet>
          <Router>
            <Sidebar
              sidebarVisible={sidebarVisible}
            ...
            >
              ...
              <Switch>
                <Route path="/register" exact component={HomePage} />
                <Route exact path="/" component={DashboardUK} />
                <Route path="/team" component={TeamsDashboardUK} />
                <Route exact path="/teams/register" component={TeamsPage} />
                <Route exact path="/faq" component={FaqPage} />
                <Route exact path="/about" component={AboutPage} />
                <Route exact path="/event-rules" component={EventRules} />
